...
public final class OAuth2LoginFlowHelper {
    ...
    public static OAuth2ProviderSettingsDto resolveProviderOrThrow(String provider, HttpServletRequest request, OAuth2LoginExternalService oauth2LoginService, AuditLogInternalService auditLogService) {
