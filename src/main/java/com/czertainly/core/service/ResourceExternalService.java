...
public interface ResourceExternalService {
    ...
    /**
     * Method to retrieve the list of objects available for object-level access control
     *
    ...
    /**
     * Update the custom attribute content for a resource object
     *
     * @param resourceName  Name of the resource
     * @param objectUuid    UUID of the object
     * @param attributeUuid UUID of the custom attribute
     * @param request       Attribute content to set (null to delete)
