...
public interface RaProfileExternalService {
     ...
     */
    RaProfileCmpDetailResponseDto getCmpForRaProfile(SecuredParentUUID authorityInstanceUuid, SecuredUUID raProfileUuid) throws NotFoundException;
     ...
     */
    RaProfileCmpDetailResponseDto activateCmpForRaProfile(SecuredParentUUID authorityUuid, SecuredUUID uuid, SecuredUUID cmpProfileUuid, ActivateCmpForRaProfileRequestDto request) throws ConnectorException, ValidationException, AttributeException, NotFoundException;
     ...
     * @throws ConnectorException in case the connector throws an exception
     */
    List<CertificateDetailDto> getAuthorityCertificateChain(SecuredParentUUID authorityUuid, SecuredUUID raProfileUuid) throws ConnectorException, NotFoundException;
